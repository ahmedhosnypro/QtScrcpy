...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        useSingleModeCheck->setObjectName("useSingleModeCheck");
        ...
        wifiConnectBtn->setObjectName("wifiConnectBtn");
        ...
        usbConnectBtn->setObjectName("usbConnectBtn");
        ...
        connectedPhoneList->setObjectName("connectedPhoneList");
        ...
        bitRateEdit->setObjectName("bitRateEdit");
        ...
        alwaysTopCheck->setObjectName("alwaysTopCheck");
        ...
        keymapOnlyCheck = new QCheckBox(configWidget3);
        keymapOnlyCheck->setObjectName("keymapOnlyCheck");
        sizePolicy.setHeightForWidth(keymapOnlyCheck->sizePolicy().hasHeightForWidth());
        keymapOnlyCheck->setSizePolicy(sizePolicy);

        gridLayout->addWidget(keymapOnlyCheck, 2, 1, 1, 1);
        ...
        updateNameBtn->setObjectName("updateNameBtn");
        ...
        stopAllServerBtn->setObjectName("stopAllServerBtn");
        ...
        getIPBtn->setObjectName("getIPBtn");
        ...
        startAdbdBtn->setObjectName("startAdbdBtn");
        ...
        usbWidget3->setObjectName("usbWidget3");
        ...
        installSndcpyBtn->setObjectName("installSndcpyBtn");
        ...
        startAudioBtn->setObjectName("startAudioBtn");
        ...
        stopAudioBtn->setObjectName("stopAudioBtn");
        ...
        deviceIpEdt = new QComboBox(wirelessGroupBox);
        ...
        deviceIpEdt->setMinimumSize(QSize(200, 0));
        deviceIpEdt->setEditable(true);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        keymapOnlyCheck->setText(QCoreApplication::translate("Widget", "Keymap Only Mode", nullptr));
#if QT_CONFIG(tooltip)
        keymapOnlyCheck->setToolTip(QCoreApplication::translate("Widget", "Enable keymap without mirroring screen", nullptr));
#endif // QT_CONFIG(tooltip)
