...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AudioOutput_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AudioOutput_t qt_meta_stringdata_AudioOutput = {
    {
        QT_MOC_LITERAL(0, 11),  // "AudioOutput"
        QT_MOC_LITERAL(12, 9),  // "connectTo"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 4)   // "port"
    },
    "AudioOutput",
    "connectTo",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_AudioOutput[] = {
...
Q_CONSTINIT const QMetaObject AudioOutput::staticMetaObject = { {
    ...
    qt_meta_stringdata_AudioOutput.offsetsAndSizes,
    qt_meta_data_AudioOutput,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AudioOutput_t,
        // Q_OBJECT / Q_GADGET
...
void AudioOutput::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->connectTo((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AudioOutput::connectTo; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
